...
<section class="advice-section">
  ...
  <button on:click={toggleTranslation}>
    {#if isTranslated}
      <img width="50" height="50" src="https://img.icons8.com/clouds/100/great-britain.png" alt="Traduire en anglais" title="Traduire en anglais" />
    {:else}
      <img width="50" height="50" src="https://img.icons8.com/clouds/100/france.png" alt="Traduire en français" title="Traduire en anglais"/>
    {/if}
  </button>
